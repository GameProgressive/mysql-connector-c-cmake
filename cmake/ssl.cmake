...
MACRO (MYSQL_USE_BUNDLED_SSL)
  ...
  SET(SSL_INTERNAL_INCLUDE_DIRS ${CMAKE_CURRENT_SOURCE_DIR}/extra/yassl/taocrypt/mySTL)
  ...
  FOREACH(file ${src})
    SET(SSL_SOURCES ${SSL_SOURCES} ${CMAKE_CURRENT_SOURCE_DIR}/extra/yassl/${file})
  ENDFOREACH()
  GET_TARGET_PROPERTY(src taocrypt SOURCES)
  FOREACH(file ${src})
    SET(SSL_SOURCES ${SSL_SOURCES}
      ${CMAKE_CURRENT_SOURCE_DIR}/extra/yassl/taocrypt/${file})
  ENDFOREACH()
ENDMACRO()
